...
this node: tcp://127.0.0.1:7877, data, celastro 0.79.0, 1 collection(s), 1 shard(s) held, directory present
node tcp://127.0.0.1:7878: up, data, celastro 0.79.0, 0 ms, clock -0.0 s
node tcp://127.0.0.1:7879: up, data, celastro 0.79.0, 0 ms, clock -0.0 s
